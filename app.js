...
// There are 898 Pokemon as of 4/21/2022 but we are only going to use 150, although when we plugged in 898, it took a while to run.
const numOfPokemon = 153;
...
function createPokeCard(pokemon){
  const pokeCard = document.createElement(`section`); // not on page yet
